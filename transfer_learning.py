...
dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=32, num_workers=4, shuffle=True) for x in ['train', 'val']}
...
def visualize_model_preds(model, num_images=6):
...
###Freezing everything except the last layer
